...
//char tmp2[sizeof(xhash_t)];
//memcpy(tmp2, ctx->tmp, sizeof(tmp2));
//const uint tmpsize2 = ctx->tmp[_XHASH_TSIZE];
...
////
    //ctx->tmp[_XHASH_TSIZE] = tmpsize2;
//memcpy(ctx->tmp, tmp2, sizeof(tmp2));
////
